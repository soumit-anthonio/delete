<template>
  ...
  <div class="container-fluid">
    <div class="card">
      <h5 class="card-header">Sub Menu Two</h5>
      <div class="card-body">
        <h5 class="card-title">
        ...
        <button-control
          :text="btnTextSubmit"
          :typeBtn="submitBtnType"
          :childclass="{ submitstyle: true }"
          v-on:btnClicked="btnClickedMeSubmit($event)"
        />
      </div>
    </div>
    ...
    etc. 5 paragraphs words bytes lists Start with 'Lorem ipsum dolor sit
    amet...' Translations: Can you help translate this site into a foreign
    language ? Please email us with details if you can help. There is a set of
    mock banners available here in three colours and in a range of standard
    banner sizes: BannersBannersBanners Donate: If you use this site regularly
    ...
    is no minimum donation, any sum is appreciated - click here to donate using
    PayPal. Thank you for your support. Donate Bitcoin:
    16UQLq1HZ3CNwhvgrarV6pMoA2CDjb4tyF NodeJS Python Interface GTK Lipsum Rails
    .NET Groovy The standard Lorem Ipsum passage, used since the 1500s "Lorem
...
export default {
  name: "SubMenuTwoComponent",
  components: {
    "button-control": Button,
  },
  data() {
    return {
      submitBtnType: BtnTypeEnum.Primary,
      btnTextSubmit: "Hello Soumit",
    };
  },
  methods: {
    btnClickedMeSubmit(argument) {
      alert("Submit " + argument);
    },
  },
};
</script>
